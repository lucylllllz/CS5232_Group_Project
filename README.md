...
---
### If you encounter difficulties deploying the current version, you can switch to the [deployment_friendly_version](https://github.com/lucylllllz/CS5232_Group_Project/tree/deployment_friendly_version) branch and follow the deployment guide in that branch to run the code.
